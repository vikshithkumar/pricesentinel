        ...
        <aside className="col-span-12 md:col-span-3 flex flex-col gap-xxs">
          {[
            ...
            <button
              ...
              className={`px-sm py-2 rounded-lg font-body text-left text-[14px] transition-colors flex items-center justify-between group ${
                activeSubTab === tab
                ...
                <div className="flex items-center justify-between py-sm pt-md">
                  ...
                  <button 
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                      tfaEnabled ? "bg-primary" : "bg-surface-container-highest"
                    }`}
                  >
                    <span className={`inline-block h-4 w-4 transform rounded-full bg-canvas-white transition-transform shadow-sm ${
